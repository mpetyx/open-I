...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column('twitter_twitteraccount', 'social_id',
                        self.gf('django.db.models.fields.BigIntegerField')(unique=True))
    ...
    models = {
        ...
        'twitter.twitteraccount': {
            ...
            'socialaccount_ptr': ('django.db.models.fields.related.OneToOneField', [],
                                  {'to': "orm['socialaccount.SocialAccount']", 'unique': 'True',
                                   'primary_key': 'True'}),
