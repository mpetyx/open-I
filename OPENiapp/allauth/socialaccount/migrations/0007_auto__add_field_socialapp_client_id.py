...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('socialaccount_socialapp', 'client_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [],
                            {'default': 'datetime.datetime(2012, 12, 22, 12, 51, 3, 966915)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [],
                           {'default': 'datetime.datetime(2012, 12, 22, 12, 51, 3, 966743)'}),
        ...
        'socialaccount.socialapp': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [],
                      {'to': "orm['sites.Site']", 'symmetrical': 'False', 'blank': 'True'})
        },
